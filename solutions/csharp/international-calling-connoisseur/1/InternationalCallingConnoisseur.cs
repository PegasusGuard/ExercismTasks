public static class DialingCodes
{
    ...
    public static Dictionary<int, string> AddCountryToExistingDictionary(
        Dictionary<int, string> existingDictionary, int countryCode, string countryName) => existingDictionary.TryAdd(countryCode, countryName) ? existingDictionary : existingDictionary;
    ...
    {
        string result = "";
        foreach (string item in existingDictionary.Values)
