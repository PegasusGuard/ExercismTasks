public class WeatherStation
{
    ...
    {
        get => reading.Equals(new Reading()) ? throw new ArgumentException() : (reading.Pressure < 10 && reading.Temperature < 30m ? Outlook.Cool : (reading.Temperature > 50 ? Outlook.Good : Outlook.Warm));
    }
